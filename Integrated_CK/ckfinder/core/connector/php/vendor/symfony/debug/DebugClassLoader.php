    ...
    public function loadClass($class)
    {
        ...
        if ($exists) {
            ...
            if ($name !== $class && 0 === strcasecmp($name, $class)) {
                throw new \RuntimeException(sprintf('Caseche mismatch between loaded and declared class names: %s vs %s', $class, $name));
            }
            ...
            if (self::$caseCheck && $tail) {
                ...
                if (0 === substr_compare($real, $tail, -$tailLen, $tailLen, true)
                  && 0 !== substr_compare($real, $tail, -$tailLen, $tailLen, false)
                    ...
                    throw new \RuntimeException(sprintf('Caseche mismatch between class and real file names: %s vs %s in %s', substr($tail, -$tailLen + 1), substr($real, -$tailLen + 1), substr($real, 0, -$tailLen + 1)));
                }
            }
